 ...
 */
    ...
    #define ESP_PANEL_LCD_SPI_IO_CS             (40)
#if !ESP_PANEL_LCD_BUS_SKIP_INIT_HOST
    #define ESP_PANEL_LCD_SPI_IO_SCK            (38)
    #define ESP_PANEL_LCD_SPI_IO_MOSI           (39)
...
/* LCD Other Settings */
/* Reset pin */
#define ESP_PANEL_LCD_IO_RST          (41)      // IO num of RESET pin, set to -1 if not use
...
/* Touch panel bus parameters */
    ...
    #define ESP_PANEL_TOUCH_I2C_IO_SCL      (21)
...
/* Interrupt pin */
#define ESP_PANEL_TOUCH_IO_INT          (0)        // IO num of INT pin, set to -1 if not use
